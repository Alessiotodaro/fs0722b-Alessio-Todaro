...
let leilaOrgana = {name: "Leia Organa", hair_color: "brown", eye_color: "brown"}

femaleCharacters.push(leilaOrgana);

console.log(femaleCharacters[0].name);
/* ESERCIZIO 4
...
/* ESERCIZIO 6
  ...
  */
  let m = 0;
  let massa = "";
  while (starWarsCharacters[m].mass) {
    massa = starWarsCharacters[0].mass + starWarsCharacters[1].mass
    m++;
  }
